...
// file.
func (app *ToriumApp) ExportAppStateAndValidators(forZeroHeight bool, jailAllowedAddrs []string, modulesToExport []string) (servertypes.ExportedApp, error) {
...
func (app *ToriumApp) prepForZeroHeightGenesis(ctx sdk.Context, jailAllowedAddrs []string) error {
